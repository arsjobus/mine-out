...
{
	return std::string(
		this->getTextureDirectoryName() + 
		"/" +
		this->getAnimationDirectoryName() +
		"/"
		);
}
...
float PreloadResources::getLoadPercentile()
{
	return this->loadPercentile;
}

void PreloadResources::setLoadPercentile(float loadPercentile)
{
	this->loadPercentile = loadPercentile;
}

int PreloadResources::getLoadedResourceCount()
{
	return this->loadedResourceCount;
}

void PreloadResources::setLoadedResourceCount(int loadedResourceCount)
{
	this->loadedResourceCount = loadedResourceCount;
}

int PreloadResources::getResourceCount()
{
	return this->resourceCount;
}

void PreloadResources::setResourceCount(int resourceCount)
{
...
void PreloadResources::setSoundFileType(const char *soundFileType)
{
...
void PreloadResources::setTextureFileType(const char *textureFileType)
{
